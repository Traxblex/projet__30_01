...
include('../../BDD/bdd.php');
     // var_dump est une fonction qui permet d'afficher le contenu d'une variable. Ici, on affiche le contenu de la variable $_POST qui contient les données du formulaire d'ajout de sport. C'est utile pour vérifier que les données sont bien reçues par le fichier ajouterSport.php
    ...
    header('location:http://127.0.0.1/Promo321/info/cours_info_shapeche/projet__30_01/index.php?page=sport');
